...
def interactive_math_demo(x=1.0, y=2.0, n=5):
    ...
    with output:
        ...
        print (get_display (arabic_reshaper.reshape (f"**** === الثوابت === **** ")))
        ...
        print (get_display (arabic_reshaper.reshape (f"**** === حسابات عامة === **** ")))
        ...
        print (get_display (arabic_reshaper.reshape (f"**** === دوال مثلثية   === **** ")))
